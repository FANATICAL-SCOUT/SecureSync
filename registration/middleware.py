...
from SecureSync.settings import DOMAIN
    ...
    def __call__(self, request):
        ...
        if request.user_agent.is_mobile or request.user_agent.is_tablet:
            ...
            if not request.path in allows:
                return HttpResponseForbidden("<h2 style='margin-top:50%; text-align:center;'>Sorry, SecureSync works only on desktop. Please use a desktop to get the best experience!</h2>")
            else:
